...
void test_array_too_small()
{
    ...
    CharT c = 'c';    
    CharT buff[3] = { 'x', 'y', 'z' };
    BOOST_TEST_THROWS(strf::write(buff)(a, b, c), std::out_of_range);
    BOOST_TEST(buff[0] == a);
    BOOST_TEST(buff[1] == b);
    BOOST_TEST(buff[2] == 0);
}
...
void test_informed_size_too_small()
{
    ...
    CharT c = 'c';    
    CharT buff[3] = { 'x', 'y', 'z' };
    BOOST_TEST_THROWS(strf::write(buff, 3) (a, b, c), std::out_of_range);
    BOOST_TEST(buff[0] == a);
    BOOST_TEST(buff[1] == b);
    BOOST_TEST(buff[2] == 0);
}
...
void test_informed_end_too_close()
{
    ...
    CharT c = 'c';
    CharT buff[3] = { 'x', 'y', 'z' };
    BOOST_TEST_THROWS(strf::write(buff, &buff[3]) (a, b, c), std::out_of_range);
    BOOST_TEST(buff[0] == a);
    BOOST_TEST(buff[1] == b);
    BOOST_TEST(buff[2] == 0);
}
...
int main()
{
    ...
    {  // When exception is thrown
        ...
        try
        {
            strf::write(result) ("abcd", exception_thrower_arg, "lkjlj");
        }
        catch(...)
        {
        }
