...
int main()
{
    ...
    }
    {
        ...
        TEST("aabbcc") .exception(strf::iterate(vec));

        TEST("..aa..bb..cc") .exception(strf::right(strf::iterate(vec), 4, '.'));

        TEST("..aa..bb..cc--") .exception
    ...
    {
        std::string vec = "abcd";
        TEST("abcd") .exception(strf::iterate(vec));
        TEST("aaabbbcccddd") .exception(strf::fmt_iterate(vec).multi(3));
        TEST("  --aaabbbcccddd--") .exception
