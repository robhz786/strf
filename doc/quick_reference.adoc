...
/*...*/ range_sep(const Range& r, const CharT* separator);

template <typename T, std::size_t N, typename CharT>
/*...*/ range_sep(T (&array)[N], const CharT* separator);

template <typename Iterator, typename CharT>
/*...*/ range_sep( const Iterator& begin
                 , const Iterator& end
...
auto str = strf::to_string("[", strf::range_sep(vec, ", "), "]");
assert(str == "[11, 22, 33]");
----
...
template <typename Range, typename CharT>
/*...*/ fmt_range_sep(const Range& r, const CharT* separator);

template <typename T, std::size_t N, typename CharT>
/*...*/ fmt_range_sep(T (&array)[N], const CharT* separator);

template <typename Iterator, typename CharT>
/*...*/ fmt_range_sep( const Iterator& begin
                     , const Iterator& end
                     , const CharT* separator );
...
`strf::fmt_range_sep(/{asterisk}\...{asterisk}/)`.
