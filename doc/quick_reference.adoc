...
- `<<encoding,encoding_c>><__CharType__>`: Affects the printing of the <<alignment_format_functions,fill character>> and of the <<numpunct,punctuation characters>>.
- `<<surrogate_policy,surrogate_policy_c>>`: Affects the printing of the <<alignment_format_functions,fill character>>.
- `<<encoding_error,encoding_error_c>>`: Affects the printing of the <<alignment_format_functions,fill character>>.
...
Facet categories::
- `<<width_calculation,width_calculation_c>>`
- `<<encoding,encoding_c>><__CharType__>`
- `<<surrogate_policy,surrogate_policy_c>>`
- `<<encoding_error,encoding_error_c>>`
