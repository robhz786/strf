...
:OutbufCreator: <<OutbufCreator,OutbufCreator>

:basic_cstr_writer: <<outbuf_hpp#basic_cstr_writer,basic_cstr_writer>>
:destination_no_reserve: <<destination,destination_no_reserve>>
:OutbufCreator: <<OutbufCreator,OutbufCreator>>
:SizedOutbufCreator: <<SizedOutbufCreator,SizedOutbufCreator>>
