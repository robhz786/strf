...
members of the facet, or specialize `facet_trait`.
...
using facet_category = facet_trait<Facet>::typename category;
----
====
...
----
::
Value::: ``facet_trait<T>::store_by_value`` if such expression
