...
class listf: public boost::stringify::input_base<charT, Output, Formating>
{
    typedef 
        std::initializer_list
            <boost::stringify::input_arg<charT, Output, Formating > >
...
public:
    ...
    using boost::stringify::input_base<charT, Output, Formating>::write;
