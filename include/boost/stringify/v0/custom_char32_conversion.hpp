...
public:
    ...
    constexpr std::size_t length(char32_t) const noexcept
    {
        return 1;
    }
...
class char32_to_utf8
    : public boost::stringify::v0::detail::char32_to_utf8_impl
{
public:
...
class char32_to_utf16
    : public boost::stringify::v0::detail::char32_to_utf16_impl<char16_t>
{
public:
...
class char32_to_utf32
    : public boost::stringify::v0::detail::char32_to_utf32_impl<char32_t>
{
public:
...
class default_char32_to_wstr
    : public boost::stringify::v0::detail::ternary_t
        ...
        , boost::stringify::v0::detail::char32_to_utf32_impl<wchar_t>
        , boost::stringify::v0::detail::char32_to_utf16_impl<wchar_t>
        >
{
...
{
    typedef  boost::stringify::v0::char32_to_str_tag<CharT> tag;
...
{
    using tag = boost::stringify::v0::char32_to_str_tag<typename Output::char_type>;
