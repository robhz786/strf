#ifndef BOOST_STRINGIFY_V1_DETAIL_INPUT_ARG_WORKAROUND_MSVC_HPP
#define BOOST_STRINGIFY_V1_DETAIL_INPUT_ARG_WORKAROUND_MSVC_HPP
...
class input_arg
{
    ...
    auto* instantiate_wrapper(const Value& x)
    {
        ...
        using stringifier_wrapper_impl =
            boost::stringify::v1::detail::stringifier_wrapper_impl<stringifier_x>;
        static_assert
...
#endif  /* BOOST_STRINGIFY_V1_DETAIL_INPUT_ARG_WORKAROUND_MSVC_HPP */
