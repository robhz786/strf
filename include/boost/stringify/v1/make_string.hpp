#ifndef BOOST_STRINGIFY_V1_MAKE_STRING_HPP
#define BOOST_STRINGIFY_V1_MAKE_STRING_HPP
...
= boost::stringify::v1::make_args_handler
    <boost::stringify::v1::detail::string_maker
        <std::basic_string<CharT, Traits>>>();


constexpr auto make_string
= boost::stringify::v1::make_args_handler
    <boost::stringify::v1::detail::string_maker<std::string>>();

constexpr auto make_u16string
= boost::stringify::v1::make_args_handler
    <boost::stringify::v1::detail::string_maker<std::u16string>>();

constexpr auto make_u32string
= boost::stringify::v1::make_args_handler
    <boost::stringify::v1::detail::string_maker<std::u32string>>();

constexpr auto make_wstring
= boost::stringify::v1::make_args_handler
    <boost::stringify::v1::detail::string_maker<std::wstring>>();
...
#endif  // BOOST_STRINGIFY_V1_MAKE_STRING_HPP
