...
inline STRF_HD uint64_t umulh(const uint64_t a, const uint64_t b) {
...
inline STRF_HD uint64_t div5(const uint64_t x) {
  return umulh(x, 0xCCCCCCCCCCCCCCCDu) >> 2;
}

inline STRF_HD uint64_t div10(const uint64_t x) {
  return umulh(x, 0xCCCCCCCCCCCCCCCDu) >> 3;
}

inline STRF_HD uint64_t div100(const uint64_t x) {
  return umulh(x >> 2, 0x28F5C28F5C28F5C3u) >> 2;
}

inline STRF_HD uint64_t div1e8(const uint64_t x) {
  return umulh(x, 0xABCC77118461CEFDu) >> 26;
}

inline STRF_HD uint64_t div1e9(const uint64_t x) {
  return umulh(x >> 9, 0x44B82FA09B5A53u) >> 11;
}

inline STRF_HD uint32_t mod1e9(const uint64_t x) {
...
inline STRF_HD bool multipleOfPowerOf5(const uint64_t value, const uint32_t p) {
