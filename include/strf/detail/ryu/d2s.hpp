...
#define STRF_RYU_DOUBLE_MANTISSA_BITS 52
#define STRF_RYU_DOUBLE_EXPONENT_BITS 11
#define STRF_RYU_DOUBLE_BIAS 1023

#define STRF_RYU_DOUBLE_POW5_INV_BITCOUNT 122
#define STRF_RYU_DOUBLE_POW5_BITCOUNT 121

#if defined(STRF_RYU_OPTIMIZE_SIZE)

#define STRF_RYU_POW5_TABLE_SIZE 26
inline const uint64_t DOUBLE_POW5_TABLE(std::size_t index)
{
static const uint64_t table[STRF_RYU_POW5_TABLE_SIZE] = {
...
inline void double_computePow5(const uint32_t i, uint64_t* const result) {
  const uint32_t base = i / STRF_RYU_POW5_TABLE_SIZE;
  const uint32_t base2 = base * STRF_RYU_POW5_TABLE_SIZE;
...
inline void double_computeInvPow5(const uint32_t i, uint64_t* const result) {
  const uint32_t base = (i + STRF_RYU_POW5_TABLE_SIZE - 1) / STRF_RYU_POW5_TABLE_SIZE;
  const uint32_t base2 = base * STRF_RYU_POW5_TABLE_SIZE;
...
#else // defined(STRF_RYU_HAS_UINT128)
...
#endif // defined(STRF_RYU_HAS_UINT128)

#endif // defined(STRF_RYU_OPTIMIZE_SIZE)

STRF_DETAIL_RYU_NAMESPACE_END;

#endif // STRF_DETAIL_RYU_D2S_HPP_INCLUDED
