...
STRF_HD inline std::ptrdiff_t tr_string_size
    ( const strf::premeasurements<strf::size_presence::no, strf::width_presence::no>*
    , std::ptrdiff_t
    , const CharT*
    , const CharT*
...
template <typename CharT, strf::size_presence PreSize, strf::width_presence PreWidth>
...
STRF_HD std::ptrdiff_t tr_string_size
    ( const strf::premeasurements<strf::size_presence::yes, strf::width_presence::no>* args_pre
