...
void STRF_TEST_FUNC test_encode_fill()
{
    {
        // UTF-8
        TEST_FILL(strf::utf<char>, 0x7F, "\x7F");
        TEST_FILL(strf::utf<char>, 0x7F, "\x7F");
        TEST_FILL(strf::utf<char>, 0x80, "\xC2\x80");
        TEST_FILL(strf::utf<char>, 0x800, "\xE0\xA0\x80");
        TEST_FILL(strf::utf<char>, 0xFFFF, "\xEF\xBF\xBF");
        TEST_FILL(strf::utf<char>, 0x10000, "\xF0\x90\x80\x80");
        TEST_FILL(strf::utf<char>, 0x10FFFF, "\xF4\x8F\xBF\xBF");
        TEST_FILL(strf::utf<char>, 0x110000, "\xEF\xBF\xBD");
    }
