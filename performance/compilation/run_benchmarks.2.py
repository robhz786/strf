...
samples_O3 = \
[ ('to_charptr',        [ ([lib_strf_O3], [strf_incl], '_stringify'    )
                        , ([lib_strf_O3], [strf_incl], '_stringify_tr' )
                        , ([libfmt_O3],   [fmt_incl],   '_fmtlib' )
                        , ([],            [],           '_sprintf')
] )
, ('to_string',         [ ([lib_strf_O3], [strf_incl], '_stringify'   )
                        , ([lib_strf_O3], [strf_incl], '_stringify_tr')
                        , ([libfmt_O3],   [fmt_incl],   '_fmtlib')
] )
, ('to_FILE',           [ ([lib_strf_O3], [strf_incl], '_stringify'    )
                        , ([lib_strf_O3], [strf_incl], '_stringify_tr' )
                        , ([libfmt_O3],   [fmt_incl],   '_fmtlib' )
                        , ([],            [],           '_fprintf')
] )
, ('to_ostream',        [ ([lib_strf_O3], [strf_incl], '_stringify'   )
                        , ([lib_strf_O3], [strf_incl], '_stringify_tr')
                        , ([libfmt_O3],   [fmt_incl],   '_fmtlib')
                        , ([],            [],           '_itself')
] )
...
samples_Os = \
[ ('to_charptr',        [ ([lib_strf_Os], [strf_incl], '_stringify'    )
                        , ([lib_strf_Os], [strf_incl], '_stringify_tr' )
                        , ([libfmt_Os],   [fmt_incl],   '_fmtlib' )
                        , ([],            [],           '_sprintf')
] )
, ('to_string',         [ ([lib_strf_Os], [strf_incl], '_stringify'   )
                        , ([lib_strf_Os], [strf_incl], '_stringify_tr')
                        , ([libfmt_Os],   [fmt_incl],   '_fmtlib')
] )
, ('to_FILE',           [ ([lib_strf_Os], [strf_incl], '_stringify'    )
                        , ([lib_strf_Os], [strf_incl], '_stringify_tr' )
                        , ([libfmt_Os],   [fmt_incl],   '_fmtlib' )
                        , ([],            [],           '_fprintf')
] )
, ('to_ostream',        [ ([lib_strf_Os], [strf_incl], '_stringify'   )
                        , ([lib_strf_Os], [strf_incl], '_stringify_tr')
                        , ([libfmt_Os],   [fmt_incl],   '_fmtlib')
                        , ([],            [],           '_itself')
] )
...
samples_debug = \
[ ('to_charptr',        [ ([lib_strf_db], [strf_incl], '_stringify'   )
                        , ([lib_strf_db], [strf_incl], '_stringify_tr')
                        , ([libfmt_db],   [fmt_incl],  '_fmtlib' )
                        , ([],            [],          '_sprintf')
] )
, ('to_string',         [ ([lib_strf_db], [strf_incl], '_stringify'   )
                        , ([lib_strf_db], [strf_incl], '_stringify_tr')
                        , ([libfmt_db],   [fmt_incl],   '_fmtlib')
] )
, ('to_FILE',           [ ([lib_strf_db], [strf_incl], '_stringify'   )
                        , ([lib_strf_db], [strf_incl], '_stringify_tr')
                        , ([libfmt_db],   [fmt_incl],  '_fmtlib' )
                        , ([],            [],          '_fprintf')
] )
, ('to_ostream',        [ ([lib_strf_db], [strf_incl], '_stringify'   )
                        , ([lib_strf_db], [strf_incl], '_stringify_tr')
                        , ([libfmt_db],   [fmt_incl],   '_fmtlib')
                        , ([],            [],           '_itself')
] ) ]
...
[ ('to_charptr',        [ ([], [strf_incl], '_stringify_ho'   )
                        , ([], [strf_incl], '_stringify_tr_ho')
                        , ([], [fmt_incl],   '_fmtlib_ho')
                        , ([], [],           '_sprintf'  )
] )
, ('to_string',         [ ([], [strf_incl], '_stringify_ho'   )
                        , ([], [strf_incl], '_stringify_tr_ho')
                        , ([], [fmt_incl],   '_fmtlib_ho')
] )
, ('to_FILE',           [ ([], [strf_incl], '_stringify_ho'   )
                        , ([], [strf_incl], '_stringify_tr_ho')
                        , ([], [fmt_incl],   '_fmtlib_ho')
] )
, ('to_ostream',        [ ([], [strf_incl], '_stringify_ho'   )
                        , ([], [strf_incl], '_stringify_tr_ho')
                        , ([], [fmt_incl],   '_fmtlib_ho')
] ) ]
