...
int main()
{
    ...
    PRINT_BENCHMARK("strf::to(u32output)(u16sample1)")
    {
        auto err = strf::to(u32output)(u16sample1);
        (void)err;
    }
    PRINT_BENCHMARK("strf::to(u32output)(u16sample4)")
    {
        auto err = strf::to(u32output)(u16sample4);
        (void)err;
    }
    ...
    PRINT_BENCHMARK("strf::to(u32output)(u8sample1)")
    {
        auto err = strf::to(u32output)(u8sample1);
        (void)err;
    }
    PRINT_BENCHMARK("strf::to(u32output)(u8sample2)")
    {
        auto err = strf::to(u32output)(u8sample2);
        (void)err;
    }
    PRINT_BENCHMARK("strf::to(u32output)(u8sample3)")
    {
        auto err = strf::to(u32output)(u8sample3);
        (void)err;
    }
    PRINT_BENCHMARK("strf::to(u32output)(u8sample4)")
    {
        auto err = strf::to(u32output)(u8sample4);
        (void)err;
    }
