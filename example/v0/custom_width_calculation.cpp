...
int main()
{
    ...
    auto s_len = strf::make_string.facets(width_as_len) (strf::right(str, 12, U'.'));
    auto s_cpc = strf::make_string.facets(width_as_cpc) (strf::right(str, 12, U'.'));
    auto s_my  = strf::make_string.facets(width_my)     (strf::right(str, 12, U'.'));
    ...
    auto s16_len = strf::make_u16string.facets(width_as_len) (strf::right(str16, 12, U'.'));
    auto s16_cpc = strf::make_u16string.facets(width_as_cpc) (strf::right(str16, 12, U'.'));
    auto s16_my  = strf::make_u16string.facets(width_my)     (strf::right(str16, 12, U'.'));
