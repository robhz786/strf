//based on https://en.wikipedia.org/wiki/ISO/IEC_8859-7
...
class ascii_iso_8859_7_decoder: public strf::decoder<char>
{

public:

    void decode(strf::u32output& dest, const char* str, const char* end) const override
    {
...
private:
    ...
    static char32_t decode(char ch)
    {
        const static char32_t table[] =
        {
            ...
            0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
            0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
            0x00A0, 0x2018, 0x2019, 0x00A3, 0x00AC, 0x20AF, 0x00A6, 0x00A7,
            ...
            0x03C8, 0x03C9, 0x03CA, 0x03CB, 0x03CC, 0x03CD, 0x03CE, 0xEFFD
        };
