...
public:
    ...
    constexpr unsigned <<numpunct_thousands_sep_count,thousands_sep_count>>(unsigned digcount) const noexcept;
...
public:
    ...
    constexpr unsigned thousands_sep_count(unsigned digcount) const noexcept;
