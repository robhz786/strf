...
Overridable:: Yes, `<<PrintingTraits_override_tag,override_tag>>` is `bool`.
...
Overridable:: Yes, `<<PrintingTraits_override_tag,override_tag>>` is `const void*`
...
Overridable:: Yes, `<<PrintingTraits_override_tag,override_tag>>` is the same as the input type ( `short`,
`int`,
`long int`,
`long long int`,
`unsigned short`,
...
Overridable:: Yes, `<<PrintingTraits_override_tag,override_tag>>` is the same as the input type ( `float` or `double` )
