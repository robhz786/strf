...
where `__T__` would be a __{Transcoder}__ class that transcodes from the source
...
where `__T__` would be a __{Transcoder}__ class that transcodes from the
...
where `__T__` would be a __{Transcoder}__ class that transcodes from
