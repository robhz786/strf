...
using no_pre_printing = pre_printing<preview_size::no, preview_width::no>;
using print_size_and_width_preview = pre_printing< preview_size::yes
                                                 , preview_width::yes >;
...
----
template < typename CharT
         , <<pre_printing,preview_size>> SizeRequired
         , <<pre_printing,preview_width>> WidthRequired
         , typename\... FPE
         , typename\... Args >
void preview
    ( {pre_printing}<SizeRequired, WidthRequired>& pp
...
(\..., {arg_printer_type}< CharT
                      , {pre_printing}<SizeRequired, WidthRequired>
                      , facets_pack<FPE\...>
