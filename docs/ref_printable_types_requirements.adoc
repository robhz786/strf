...
----
template < typename CharT
         , <<premeasurements,precalc_size>> PrecalcSize
         , <<premeasurements,precalc_width>> PrecalcWidth
         , typename\... FPE
         , typename\... Args >
void precalculate
    ( {premeasurements}<PrecalcSize, PrecalcWidth>* pp
...
----
(\..., {printer_type}< CharT
                  , {premeasurements}<PrecalcSize, PrecalcWidth>
                  , facets_pack<FPE\...>
