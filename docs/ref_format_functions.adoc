...
* otherwise, it is `{printable_with_fmt}<PrintableDef, Fmts\...>`, where:
...
***  If `PrintableDef::format_specifiers` is not defined, `T` is `{printable_with_fmt}<PrintableDef>`.
...
public:
    ...
    constexpr <<printable_with_fmt_vwf2_t_i,printable_with_fmt>>
        ( const printable_with_fmt<PrintableDef, OtherFmts\...>& other
        , {tag}<Fmt>
