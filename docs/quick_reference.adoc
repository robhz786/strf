...
template <typename CharT> using ascii = /*...*/;
template <typename CharT> using iso_8859_1 = /*...*/;
template <typename CharT> using iso_8859_2 = /*...*/;
template <typename CharT> using iso_8859_3 = /*...*/;
template <typename CharT> using windows_1250 = /*...*/;
template <typename CharT> using windows_1251 = /*...*/;
template <typename CharT> using windows_1252 = /*...*/;
template <typename CharT> using utf8 = /*...*/;
template <typename CharT> using utf16 = /*...*/;
template <typename CharT> using utf32 = /*...*/;
...
* The `<<strf_hpp#width_as_fast_u32len,width_as_fast_u32len>>` facet value
  ...
  it assumes that the measured string is conformant to its encoding.
