...
* `__end__ >= __char_ptr__`
//-
Return type:: `<<outbuff_hpp#basic_char_array_writer,basic_char_array_writer<__CharT__>::result`>>
Return value:: a value `r`, such that:
...
| `<<outbuff_hpp#basic_char_array_writer, basic_char_array_writer>><__CharT__>`
...
or that is impossible to write, in a conformant way, in the destination charset.
