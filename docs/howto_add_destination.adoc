...
:pointer: <<destination_hpp#destination_pointer,pointer>>
:set_good: <<destination_hpp#destination_set_good,set_good>>
:set_pointer: <<destination_hpp#destination_set_pointer,set_pointer>>
...
`<<destination_hpp#destination_end,end>>` and
`<<destination_hpp#destination_pointer,pointer>>` functions respectively.
...
`pointer()`. After that, you shall call the `<<destination_hpp#destination_advance,advance>>`
